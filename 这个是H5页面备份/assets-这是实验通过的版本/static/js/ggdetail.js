$(function(){
	...
	requestHybrid({tagname:'get',param:{url:'http://192.168.0.200:9090/v1/kjh/one?name='+cpname},callbackId:"renderDetail",callback:renderDetail});
...
//	初始化最近30期
	...
	requestHybrid({tagname:'get',param:{url:"http://192.168.0.200:9090/v1/kjh/limit?name="+cpname+"&limit=30"},callbackId:"renderLimit30",callback:renderLimit30});
